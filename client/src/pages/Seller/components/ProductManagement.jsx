...
import { Card, Tag, Space, message, Tooltip } from "antd";
...
const ProductManagement = () => {
  ...
  const filterConfig = [
    ...
    },
    {
      type: "select",
      key: "isActive",
      placeholder: "Trạng thái (Hệ thống)",
      options: [
    ...
    },
    {
      ...
      options: [
        { value: "NORMAL", label: "Đang bán" },
        { value: "DRAFT", label: "Bản nháp" },
        { value: "UNLIST", label: "Đã ẩn" },
      ],
    },
    {
      type: "select",
  ...
  const handleView = (record) => {
    navigate(`/seller/product/${record._id}`);
  };

  const handleEdit = (record) => {
    navigate(`/seller/edit-product/${record._id}`);
  };
  ...
  return (
    <Card title={`Quản lý sản phẩm của tôi`} bordered={false}>
      <FilterPanel
        config={filterConfig}
